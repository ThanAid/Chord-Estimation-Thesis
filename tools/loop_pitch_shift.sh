...
DEST_PATH=/home/thanos/Documents/Thesis/audio/TheBeatlesShifted_Noise
...
do
  ...
  python3 ../src/pitch_shifter.py --directory $DIRECTORY --dest_dir $DEST_PATH/shifted_$n_steps --n_steps $n_steps --pool --noise
done
