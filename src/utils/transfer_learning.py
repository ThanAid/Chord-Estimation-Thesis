...
class TransferLearning:
    ...
    """
    def __init__(self, model_path, label_col, cache_path, dest_model, n_sliced_layers=2, batch_size=32, lr=0.001, epochs=10):
    ...
    def train(self):
        ...
        # Train the model
        self.model.fit(self.train_gen, epochs=10, validation_data=self.test_gen)
        return self
...
if __name__ == "__main__":
    ...
    model_path = '../deep_cnn/models/CQT_cnn_root_10.h5'
    label_col = 'extension_2'
    cache_path = '../deep_cnn/data_cache'
