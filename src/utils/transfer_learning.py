...
class TransferLearning2D:
    ...
    def add_layers(self):
        ...
        self.model.add(tf.keras.layers.Conv2D(128, kernel_size=(3, 3), activation='relu', padding='same',
                                              name='bass_conv2')),
        self.model.add(tf.keras.layers.BatchNormalization(name='BatchNorm_bass')),
        self.model.add(tf.keras.layers.MaxPooling2D(pool_size=(1, 3), name='MaxPooling_bass')),
        self.model.add(tf.keras.layers.Dropout(0.4, name='Dropout_bass')),
        self.model.add(tf.keras.layers.TimeDistributed(tf.keras.layers.Flatten(), name='Flatten_bass'))
